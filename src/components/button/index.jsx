...
const Button = ({
  ...
  const buttonClasses = classNames(
    ...
    {
      "text-white bg-black px-medium-x py-medium-y  text-xxii rounded-full hover:bg-gradient-to-r hover:from-black/50 hover:to-black/60 transform hover:scale-[1.02] hover:shadow-sm":
        variant === "primary",
