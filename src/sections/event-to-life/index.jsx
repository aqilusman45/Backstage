      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <Heading
            ...
            subTitle="to life"
            otherClasses="text-center md:text-start w-full md:w-2/3"
          />
          <div className="hidden md:flex justify-end items-center gap-4">
            <button
              onClick={() => sliderRef.current.slickPrev()}
              className="p-5 rounded-full bg-gray-800 hover:bg-gray-800/80 transition-all ease-in-out duration-300 flex items-center justify-center"
            >
              <Image
            ...
            <button
              ...
              className="p-5 rounded-full bg-primary hover:bg-primary/80 transition-all ease-in-out duration-300 flex items-center justify-center"
            >
              <Image
