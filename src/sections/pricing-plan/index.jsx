...
export default function PricingPlan({ otherClasses }) {
  ...
  return (
    <section className={pricingPlanClasses} data-testid="pricing-plan">
      <div className="my-14 lg:my-20 text-center max-w-1120 mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:flex items-center justify-center flex-wrap gap-4 mb-20">
